...
export function HeroOrbitArtwork() {
  ...
  return (
    <motion.div style={{ y: parallaxY }} className="relative h-full w-full">
      ...
      >
        <div
          className="pointer-events-none absolute left-1/2 top-1/2 h-[75%] w-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full blur-2xl"
          style={{
            background:
              "radial-gradient(circle, rgba(109,7,26,0.09) 0%, rgba(255,251,240,0.45) 45%, transparent 72%)",
          }}
        />
